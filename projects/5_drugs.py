...
label = tk.Label(mainw, text="Введите название лекарства")
label.grid(row=0, column=0, columnspan=2, sticky='nsew')
entry_listener = tk.StringVar()
entry_listener.set("")
entry = tk.Entry(mainw, textvariable=entry_listener)
...
box = tk.Listbox(mainw, xscrollcommand=sx.set, yscrollcommand=sy.set, width=40, height=30)
