...
class CurrencyExchangeWindow(tk.Tk):
    ...
    def __init__(self):
        ...
        self.minsize(width=260, height=377)
        self.maxsize(width=260, height=377)
        self.geometry("260x377")
        self.label = tk.Label(self, text='Курс валюты ' + self.currency)
        ...
        self.box = tk.Listbox(self, width=40, height=20, xscrollcommand=self.sx.set, yscrollcommand=self.sy.set)
